...
var setupScreenshotAttachmentStep = (originalName, name) => {
  ...
  if (step && (0, _steps.isLogStep)(step)) {
    ...
    } = (0, _utils2.resolveConsoleProps)(step.log);
...
var isApiStepErrorLogEntry = entry => {
  ...
  return name === "then" && Object.is((0, _utils2.resolveConsoleProps)(entry).props["Applied To"], _steps.ALLURE_STEP_CMD_SUBJECT);
};
var getCommandLogStepName = entry => {
  ...
  var resolvedMessage = ((_ref2 = (_ref3 = (_maybeGetAssertionLog = maybeGetAssertionLogMessage(entry)) !== null && _maybeGetAssertionLog !== void 0 ? _maybeGetAssertionLog : maybeGetCucumberLogMessage(entry)) !== null && _ref3 !== void 0 ? _ref3 : (0, _utils2.resolveRenderProps)(entry).message) !== null && _ref2 !== void 0 ? _ref2 : message).trim();
...
var getLogProps = entry => {
  ...
  var {
    props,
    name
  } = (0, _utils2.resolveConsoleProps)(entry);
...
var maybeGetAssertionLogMessage = entry => {
  if (isAssertLog(entry)) {
    var message = (0, _utils2.resolveConsoleProps)(entry).props.Message;
