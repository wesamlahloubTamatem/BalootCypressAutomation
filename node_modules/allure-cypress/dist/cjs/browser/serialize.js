...
exports.serializeAsObject = exports.default = void 0;
...
var serializeAsObject = value => {
  if (isPlainObject(value)) {
    var cleaned = _stripAncestorRefs(value);
    return (0, _sdk.serialize)(_objectSpread({}, cleaned), getSerializeOptions());
  }
  return (0, _sdk.serialize)(value, getSerializeOptions());
};
